...
<div class="max-w-4xl mx-auto bg-white shadow-md rounded-2xl p-8 mt-10">
    ...
    <form method="POST" action="{{ route('roles.update', $role->id) }}">
        ...
        <div>
            ...
            <div class="flex justify-between items-center mb-3">
                <div class="flex items-center space-x-2">
                    <input type="checkbox" id="admin_access" class="rounded text-indigo-600">
                    <label for="admin_access" class="text-gray-700 font-medium">Administrator Access</label>
                </div>
                <div class="flex items-center space-x-2">
                ...
                <div class="py-3 grid grid-cols-4 items-center">
                    ...
                    <div class="col-span-3 flex gap-8">
                        ...
                        <label class="inline-flex items-center space-x-2">
                            ...
                            <span class="text-gray-700 capitalize">{{ Str::after($perm->name, $groupName . ' ') }}</span>
                        </label>
                        @endforeach
                    </div>
                </div>
        ...
        <div class="flex justify-end mt-8 space-x-3">
            <button type="submit"
                class="px-5 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">Submit</button>
